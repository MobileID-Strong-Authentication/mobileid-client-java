...
public class ProfileDeviceInfo {
    ...
    public void setState(ProfileDeviceState state) {
        this.state = state;
    }
    ...
    public void setPinState(ProfileDevicePinState pinState) {
    ...
    public void setCertificates(List<ProfileMobileUserCertificate> certificates) {
