...
public class Sim {
    ...
    public Sim withMobileUserCertificate(List<MobileUserCertificate> mobileUserCertificate) {
        this.mobileUserCertificate = mobileUserCertificate;
        return this;
    }
    ...
    public Sim withPinStatus(PinStatus pinStatus) {
        this.pinStatus = pinStatus;
        return this;
    }
    ...
    public Sim withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sim.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
